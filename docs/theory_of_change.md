...
| **Funding** | Grant funding (Open Philanthropy, Coefficient Giving, and others) enabling paid roles and program operations |
| **Human capital** | A Director, chapter co-directors, team leads, volunteer teams, and an Advisory Board |
| **Academic partnerships** | Relationships with PhD+ supervisors across Dutch universities |
| **International network** | Connections to AI safety organizations at Oxford, Harvard, Berkeley, Carnegie Mellon, and others |
...
| Output | Target (Year 1) | Target (At Scale) |
|--------|-----------------|-------------------|
| Course graduates per year | ~60 | 250+ |
| Active research projects | 6+ | 25+ supervised, many open collaborations |
| Peer-reviewed publications | Continuing (NeurIPS, ICLR) | Growing annual count |
| Events hosted per year | Regular local + 1-2 national | Multiple national + frequent local |
| Active chapters | 4 (Groningen, Amsterdam, Delft, Utrecht) | 8-10+ cities |
| People reached | Hundreds directly, thousands via content | Thousands directly, tens of thousands via content |
...
The theory rests on assumptions that SAIN must continuously test:

| # | Assumption | How We Test It |
|---|-----------|----------------|
| 1 | **Education shifts career trajectories.** Course graduates are meaningfully more likely to pursue AI safety-relevant work. | Track alumni career outcomes; survey graduates on career influence. |
| 2 | **A unified national brand increases authority.** "SAIN Amsterdam" is taken more seriously than an independent local initiative. | Monitor partnerships, media mentions, funder interest, and recruiting outcomes pre- and post-rebrand. |
| 3 | **Central support outperforms isolation.** Playbooks, infrastructure, and mentorship lead to stronger chapters. | Compare growth and retention in SAIN chapters vs. unaffiliated local AISIs. |
| 4 | **Volunteer motivation scales.** The volunteer-heavy model remains viable as the organization grows. | Track retention rates; identify where paid roles become necessary. |
| 5 | **Sufficient latent demand exists.** Enough people in Dutch cities care about AI safety to sustain multiple chapters. | Track enrollment, attendance, and chapter formation. Amsterdam's 70+ course participants is an early signal. |
| 6 | **Structured research programs develop talent.** The Research Hub produces researchers who contribute professionally to AI safety. | Track publications, career paths, and supervisor satisfaction. |
| 7 | **Fiscal sponsorship attracts local groups.** The ability to receive grants through SAIN's legal entity is a strong enough incentive for local AISIs to adopt the brand. | Track adoption rates and the role fiscal sponsorship plays in decisions. |
...
**Research works.** Publications at NeurIPS (including spotlight) and ICLR. 6+ active projects, ~20 people, 4+ PhD-level supervisors. Successfully recruited supervisors who previously had no involvement in AI safety.
...
**The brand matters.** Open Philanthropy funding (external validation from a major international funder). Invited speaking at TEDx, EAGx Amsterdam, AiGrunn, Samenwerking Noord. Municipal consulting partnership (Westerkwartier). International connections to groups at Oxford, Harvard, Berkeley, and Carnegie Mellon.

**Scaling has early traction.** Four cities are confirmed or enthusiastic about adopting the SAIN brand. Amsterdam is already running activities using AISIG-derived playbooks. Strong interest from additional cities (e.g., Eindhoven, near ASML).

---

## 6. Scaling Logic

The chapter model produces a **virtuous cycle** that is central to the theory:

- More chapters → larger national footprint → stronger brand → more authority
