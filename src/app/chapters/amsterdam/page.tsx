...
const amsterdamPositions = chapterPositions.find(
  (c) => c.chapterSlug === "Amsterdam",
);
const amsterdamIsRecruiting =
  amsterdamPositions?.status === "open" &&
  (amsterdamPositions.postings?.length ?? 0) > 0;
