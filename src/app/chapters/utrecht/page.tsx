...
const utrechtPositions = chapterPositions.find(
  (c) => c.chapterSlug === "Utrecht",
);
const utrechtIsRecruiting =
  utrechtPositions?.status === "open" &&
  (utrechtPositions.postings?.length ?? 0) > 0;
