...
lija Lichkovski (Research Lead)

*Table of Contents*

[***Purpose, Principles, and Scope	3***](#purpose,-principles,-and-scope)

[*Who This Handbook Is For	3*](#who-this-handbook-is-for)

[*Mission and Research Scope	3*](#mission-and-research-scope)

[*Core principles	4*](#core-principles)

[***Structure of the SAIN Research Hub	5***](#structure-of-the-sain-research-hub)

[*Program Modes	5*](#program-modes)

[*Eligibility	5*](#eligibility)

[*Application Requirements and Criteria	5*](#application-requirements-and-criteria)

[*Roles and Responsibilities	5*](#roles-and-responsibilities)

[***Research Lifecycle at SAIN	7***](#research-lifecycle-at-sain)

[*Onboarding	7*](#onboarding)

[*Research Proposal Stage	7*](#research-proposal-stage)

[*Assignment & Setup	7*](#assignment-&-setup)

[*Execution Phase	8*](#execution-phase)

[*Completion Phase	8*](#completion-phase)

[*Post-Project	8*](#post-project)

[*For Supervisors	8*](#for-supervisors)

[***Expectations and Standards	9***](#expectations-and-standards)

[***Deliverables and Milestones	9***](#deliverables-and-milestones)

[***Funding, Support, and Constraints	10***](#funding,-support,-and-constraints)

[***Communication Norms	10***](#communication-norms)

[***Research Integrity, Safety, and Ethics	10***](#research-integrity,-safety,-and-ethics)

[*Integrity	10*](#integrity)

[*Responsible Use of AI Tools	11*](#responsible-use-of-ai-tools)

[*Dual-Use and Infohazards	11*](#dual-use-and-infohazards)

[***Wellbeing and Support	11***](#wellbeing-and-support)

[***Escalation, Conflict Resolution, and Sanctions	12***](#escalation,-conflict-resolution,-and-sanctions)

[*When to Notify Someone	12*](#when-to-notify-someone)

[*Notification Path	12*](#notification-path)

[*Possible Sanctions or Remedies	12*](#possible-sanctions-or-remedies)

## 

## Purpose, Principles, and Scope {#purpose,-principles,-and-scope}
...
1. We appreciate intellectual honesty. Always accurately communicate what is known, unknown, and uncertain.   
2. Proactively consider both near-term and long-term harms, as well as dual-use concerns (explained more in-depth below).   
3. Maintain a supportive environment across disciplines and seniority levels. There is zero room for harmful authority.  
4. Feedback, critique, and review are essential tools to ensure your work is up to standard. When receiving feedback, remember this is not a personal attack. When giving feedback, attack the ideas, not the person. 
...
## Structure of the SAIN Research Hub {#structure-of-the-sain-research-hub}

### Program Modes {#program-modes}

The Research Hub currently operates in the two following modes:

1. **Supervised Research Matching**  
...
2. **Open Collaboration Opportunities**  
...
### Application Requirements and Criteria {#application-requirements-and-criteria}
...
* **Research Lead and Research Operations** focus on project management, unblockers, and research support. Primary contact should go to them: [research@safeainetherlands.org](mailto:research@safeainetherlands.org).

## Research Lifecycle at SAIN {#research-lifecycle-at-sain}
...
### Research Proposal Stage  {#research-proposal-stage}
...
For **Supervised Research Matching** or **joining an open collaboration project**, please refer to the forms ([Supervised Research \- Expression of Interest](https://docs.google.com/forms/d/e/1FAIpQLSedM6m7WjjFmztnBvzsSoFkpi9X7LvMiUv2MtyGNisPXPZNNw/viewform) or by reaching out to [research@safeainetherlands.org](mailto:research@safeainetherlands.org)).
...
* Output and relevant other resources (e.g., data, code, notes, and drafts) are stored in [SAIN’s project archive](https://safeainetherlands.org/research#:~:text=Research%20from%20our%20community).  
...
* The supervisor sends the research proposal alongside the list of researchers in the project (with contact details; discord username (and github username, if applicable) as a minimum) to [**research@safeainetherlands.org**](mailto:research@safeainetherlands.org)**.**
...
* Every week, on Sundays, the researchers fill in the [weekly check-in form](https://docs.google.com/forms/d/1Uu4JrMh9j6iNa4seeIyqPnkCtikFXPgT8-pUPnwzVVE/).  
* Every two weeks, on Sundays, the supervisor fills in the [bi-weekly check-in form](https://docs.google.com/forms/d/1bBQ8jstIOWAFzOuskhLMv9lnGvcU87ZTtSSKo8mni9o/edit).
...
1. **Intermediate milestones.** For example:  
...
2. **Final deliverables.** One or more of, for instance:  
   * Research paper at a conference, journal, or workshop.  
   * Blog post at [SAIN’s Substack](https://aisig.substack.com/) and/or LessWrong.  
   * Policy brief.  
...
## Funding, Support, and Constraints {#funding,-support,-and-constraints}
...
## Research Integrity, Safety, and Ethics {#research-integrity,-safety,-and-ethics}
...
### Responsible Use of AI Tools {#responsible-use-of-ai-tools}
...
### Dual-Use and Infohazards {#dual-use-and-infohazards}
...
## Wellbeing and Support {#wellbeing-and-support}
...
## Escalation, Conflict Resolution, and Sanctions {#escalation,-conflict-resolution,-and-sanctions}
...
### When to Notify Someone {#when-to-notify-someone}
...
### Possible Sanctions or Remedies {#possible-sanctions-or-remedies}
